...
def test_scipy_from_methods():
    ...
    def cube():
        return mpj.magnet.Cuboid(polarization=(11, 22, 33), dimension=(1, 1, 1))
...
def test_copy_order():
    ...
    thing1 = mpj.magnet.Cuboid(style_label="t1")
    thing2 = mpj.magnet.Cuboid(style_label="t2")
    thing3 = mpj.magnet.Cuboid(style_label="t3")
    coll = mpj.Collection(thing1, thing2, thing3)
...
def test_describe_with_label():
    ...
    # pylint: disable=protected-access
    x = mpj.magnet.Cuboid(style_label="x1")
...
def test_describe_with_many_pixels():
    """testing describe method"""
    x = mpj.Sensor(pixel=[[[(1, 2, 3)] * 5] * 5] * 3, handedness="left")
    test = [
...
def test_describe_with_triangularmesh():
    ...
    x = mpj.magnet.TriangularMesh.from_ConvexHull(
        polarization=(0, 0, 1),
        points=points,
